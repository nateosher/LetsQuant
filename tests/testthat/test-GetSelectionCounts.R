test_that("`GetSelectionCounts` works", {
  ...
  expect_equal(selection_count_tib$selection_counts[2], 10)
  expect_equal(selection_count_tib$selection_counts[3], 21)
  expect_equal(selection_count_tib$selection_counts[4], 2)
  expect_equal(selection_count_tib$selection_counts[5], 21)

  # Check sum (haha)
  expect_equal(sum(selection_count_tib$selection_counts), 1680)
